...
vim.keymap.set('n', '<leader>qq', '<C-w><C-q>', { desc = 'Close window' })
vim.keymap.set('n', '<leader>fq', ':q!<CR>', { desc = 'Force quit window' })
vim.keymap.set('n', '<leader>wq', ':wq<CR>', { desc = 'Save and close buffer' })
...
require('lazy').setup({
  ...
  'chaoren/vim-wordmotion',
  {
    ...
    config = function()
      require('lsp_signature').setup { always_trigger = true }
    end,
  },
